...
const Cart = ({ handleAddToCart }) => {
        ...
        useEffect(() => {
            if (productIds.length > 0) {
                const fetchedProducts = productsData.filter(product => productIds.includes(product.id));
        ...
        <div className="cart-container">
            ...
            <div className="cart">
                ...
                <Link to='/'>  <button className='transparent-btn'>Return To Shop</button></Link>
                    <button className='transparent-btn' onClick={deleteItems}>Clear Cart</button>
                    ...
                    <div className="contain-bottom">
                        ...
                        <div className="info">
                            ...
                            <button className='orange-btn' onClick={processCheck}>Buy Now</button>
                            </form>
